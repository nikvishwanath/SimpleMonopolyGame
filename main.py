...
while game_over != 1:
    ...
    print(player_turn + "'s Position: Space " + str(game.get_player_current_position(player_turn)))
    ...
    # For any other space landed on, if it doesn't have an owner, give the player the option to purchase it.  
        ...
        if game.get_current_space_owner(game.get_player_current_position(player_turn)) is None:
            purchase_price = game.get_spaces_list()[game.get_player_current_position(player_turn)].get_purchase_price()
            rent_amount = game.get_spaces_list()[game.get_player_current_position(player_turn)].get_rent_amount()
